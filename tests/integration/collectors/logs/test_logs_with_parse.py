...
def minion(master: SaltMaster, analytics_events_dump_directory, tmp_path_factory) -> SaltMinion:
    ...
    config_path = tmp_path_factory.mktemp("parsing_config")

    drain_config_file = config_path / "drain3.ini"
    ...
    """.format(
        test_log_file, drain_config_file, analytics_events_dump_directory
    )
